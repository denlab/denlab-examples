...
(html/html-view (hc/html [:a {:href="https://clojure.org/guides/spec"} "clojure spec guide"]))
;; @@
;; =>
;;; {"type":"html","content":"<a href==\"https://clojure.org/guides/spec\">clojure spec guide</a>","value":"#gorilla_repl.html.HtmlView{:content \"<a href==\\\"https://clojure.org/guides/spec\\\">clojure spec guide</a>\"}"}
;; <=
